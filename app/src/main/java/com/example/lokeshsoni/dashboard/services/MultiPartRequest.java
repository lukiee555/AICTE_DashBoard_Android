...
public class MultiPartRequest extends Request<String> {
    ...
    public MultiPartRequest(String url, final Map<String, String> params, File imageFile, String filename, String fileFieldName, Response.ErrorListener errorListener, Response.Listener<String> listener ){
